      ...
      <div class="_form">
        <form action="#">
          ...
          >
            ...
            <button class="_add-btn" @click="removeIngredient(index)">X</button>
          </div>
          <div class="form-row">
          ...
          >
            <div class="input-data">
              <input type="text" required v-model="step[index]" />
              <div class="underline"></div>
              <label for="">Step {{ index + 1 }}</label>
            </div>
            <button class="_add-btn" @click="removeStep(index)">X</button>
          </div>
          <div class="form-row">
...
export default defineComponent({
  ...
  setup() {
    ...
    function addRecipe() {
      console.log('o/p→', editedRecipe.value)
